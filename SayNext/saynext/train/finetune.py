...
class LazySupervisedDataset(Dataset):
    ...
    def _process_video(self, video_path, max_frames, sampling_interval):
        ...
        for frame_index in frame_indices:
            ...
            cap.set(cv2.CAP_PROP_POS_FRAMES, frame_index)  # 设置帧位置
            ret, frame = cap.read()
            if not ret:
                break  # 如果读取失败，停止
    ...
    def get_exp(self, index, video_file, sampling = True):
        exp_caption_json_path = "/scratch/project_2011211/yyy/InternVL/exp_cap/cap_indep/exp_cap_train_indep_0.65.json"
